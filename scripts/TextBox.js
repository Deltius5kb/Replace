class TextBox{
    ...
    Render(){
        ...
        for (var i = 0; i < linesList.length; i++){
            context.fillText(linesList[i], this.#innerX + Math.round(this.#lineWidth / 2), y);
            y += this.#textHeight;
        }
        this.#drawn = true;
    }
...
class DialogueBox{
    ...
    Render(){
        ...
        for (var i = 1; i < 4; i++){
            ...
            if (this.hovering != null && i == this.hovering + 1){
                ...
                context.fillStyle = "#ffffff"; // For the text colour which is drawn after
            }
            else{
                // Fills background as black and makes text grey
                context.fillStyle = this.#defaultBackgroundColour;
                context.fillRect(this.#innerX, this.#lineHeight * i + this.#innerY, this.#lineWidth, this.#lineHeight);
                context.fillStyle = "#808080"; // For the text colour which is drawn after
            }
